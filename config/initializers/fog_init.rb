...
CarrierWave.configure {|config| config.fog_directory = 'albm-josephwaine-regular'} if Rails.env.development?
CarrierWave.configure {|config| config.fog_directory = 'albm-josephwaine-test'} if Rails.env.test?
